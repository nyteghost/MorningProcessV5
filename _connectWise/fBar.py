...
if not ls:
    ...
    isolatedsafety.df_to_sql(pdfDF, 'dbo_temp_backup_report')
    isolatedsafety.call('dbo_uspgenbackupissuereport')
    conn = isolatedsafety.connection()
    ...
    GenBackupReportQuery = f"dbo_uspgenbackupissuereport;"
    ...
    for tID in UniqueNames:
        ...
        memberList = ['MBrown', 'MShull', 'BKrusac', 'NTraverse', 'JBowman', 'JTrimble', 'NBowman', '']
        try:
            ...
            for i in ls:
                ...
                if i.member['identifier'] in memberList or i.member['identifier'] is None:
